...
class Carousel extends Component {
    ...
    componentDidMount() {
        // console.log('this.props.isRehydrated, this.props.show.navigationSnackbar :', this.props.isRehydrated, this.props.show.navigationSnackbar);
        if (this.props.isRehydrated && this.props.show.navigationSnackbar && !this.props.show.help) {
            // console.log('blink from mount');
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.isRehydrated) {
            if (nextProps.show.navigationSnackbar && !nextProps.show.help && !localStorage.getItem('navigationSnackbar')) {
                this.setState({
                    open: true
                })
                setTimeout(() => {
